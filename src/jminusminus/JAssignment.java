...
class JAndAssignOp extends JAssignment {
    ...
    /**
     * Code generation for &= involves, generating code for loading any
     * necessary l-value onto the stack, for loading the r-value, for
     * (unless a statement) copying the r-value to its
     * proper place on the stack, and for doing the store.
     *
     * @param output
     *            the code emitter (basically an abstraction for producing the
...
class JRShiftFillAssignOp extends JAssignment {
    ...
    public JRShiftFillAssignOp(int line, JExpression lhs, JExpression rhs) {
        super(line, ">>>=", lhs, rhs);
    }
